...
async def main() -> None:
    ...
    # Set up memory exporter and file export. Done here (not at module import) so that
    # pytest collecting this test_*.py file does not initialize global telemetry and
